...
const Footer = () => {
  ...
  return (
    <Box
      ...
      sx={{
        background: `linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, ${isDark ? `0.35` : `0.08`}) 100%)`,
        scrollMarginTop: 6,
      }}
    >
      <Container>
      ...
      {showThemeAuthor && (
        ...
        >
          ...
          <div sx={{ mx: 1 }}>by</div>
          {` `}
          <Link aria-label="Link to the theme author's website" href="https://www.lekoarts.de?utm_source=emilia&utm_medium=Theme">
            LekoArts
          </Link>
        </Container>
      )}
