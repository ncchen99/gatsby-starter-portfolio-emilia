...
import Svg from "@lekoarts/gatsby-theme-emilia/src/components/svg"
...
const HeaderProject = ({ title, areas, description = ``, date }: HeaderProjectProps) => {
  ...
  const descriptionProps = useSpring({ config: config.slow, delay: 700, from: { opacity: 0 }, to: { opacity: 1 } })
      ...
      <Container sx={{ textAlign: `center`, my: 4, zIndex: 10 }}>
        ...
        <div sx={{ mt: 4, mb: [6, 6, 7] }}>
          ...
          <animated.div style={infoProps}>
            ...
            <div sx={{ mt: 1, opacity: 0.8, fontSize: [1, 2] }}>
            ...
            <animated.div style={descriptionProps}>
              <div
                sx={{
                  ...
                  fontSize: [1, 2],
                  lineHeight: 1.7,
                  p: { mt: 0, mb: 3, overflowWrap: `break-word` },
                  "p:last-child": { mb: 0 },
                  "h1, h2, h3, h4, h5, h6": { textAlign: `center`, mt: 4, mb: 3 },
                }}
              >
                {description}
              </div>
